    ...
    while repeat:
        ...
        try:
            ...
            for p in range(1, number_of_phones + 1):
                ...
                phone.set_phone_number(input(f'Enter phone number for {p} phone (for example "+380123456789"): '))
...
for i, n in enumerate(phones):
    print(f'Phone number {i + 1}: {n.get_phone_number(), n.get_number_of_call()}')
